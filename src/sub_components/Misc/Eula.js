			...
			<div className='eula'>
				<div className='eula-scroller'>
					...
					<p>
						...
						delete all copies of the Application from your mobile device or from your computer.
					</p>
					...
					<p>
						The Application and related documentation are "Commercial Items", as that term is
						defined under 48 C.F.R. §2.101, consisting of "Commercial Computer Software" and
						"Commercial Computer Software Documentation", as such terms are used under 48 C.F.R.
						§12.212 or 48 C.F.R. §227.7202, as applicable. In accordance with 48 C.F.R. §12.212 or
					...
					<p>
						You may not export or re-export the Application except as authorized by United States
						law and the laws of the jurisdiction in which the Application was obtained.
					</p>

					<p>
						In particular, but without limitation, the Application may not be exported or
						re-exported (a) into or to a nation or a resident of any U.S. embargoed countries or (b)
					...
					<p>
						By installing or using any component of the Application, you represent and warrant that
						you are not located in, under control of, or a national or resident of any such country
						or on any such list.
					</p>
					...
					<p>
						...
						this Agreement and your use of the Application. Your use of the Application may also be
					...
					<p>
						...
						the International Sale of Good.
					</p>
