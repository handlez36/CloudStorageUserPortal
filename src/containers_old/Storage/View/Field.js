...
const desc = {
	'customer ip':
		'This IP address should be assigned to your router interface connecting to DCBLOX.',
	'subnet mask': 'This is the subnet mask for your router interface connecting to DCBLOX.',
	'vlan tag':
	...
	'share ip':
		'This IP address is used to access this specific share. It should be mapped in your DNS or local hosts file to cloudstorage01.dcblox.com.',
	type: 'Your storage is either File (SMB) or Object (S3), based upon the service you requested.',
	accessibility:
		'Your storage is accessible via Public (secure Internet connection) or Private (a direct connection to DC BLOX colocation or other private network).',
