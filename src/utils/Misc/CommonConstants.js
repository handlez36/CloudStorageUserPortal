import { MENU as BILLING_MENU } from './../BillingConstants';
import { MENU as SUPPORT_MENU } from './../TicketConstants';
import { MENU as PROFILE_MENU } from './../ProfileConstants';
import { MENU as STORAGE_MENU } from './../StorageConstants';
...
export const SITE_PAGES = {
	...
	[SITE_MODULES.SUPPORT]: {
		[SUPPORT_MENU.OVERVIEW]: 'OVERVIEW',
	...
	[SITE_MODULES.PROFILE]: {
		[PROFILE_MENU.CUSTOMER_PROFILE]: 'CUSTOMER CONTACT INFO',
		[PROFILE_MENU.USER_PROFILE]: 'USER CONTACT INFO',
		[PROFILE_MENU.USER_MANAGEMENT]: 'USER ACCESS',
		[PROFILE_MENU.PASSWORD_CHANGE]: 'PASSWORD',
