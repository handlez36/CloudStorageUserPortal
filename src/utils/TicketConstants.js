...
export const MENU = {
	...
	CREATETICKETBILLING: 'CREATE BILLING TICKET',
	CREATETICKETOUTAGE: 'CREATE OUTAGE TICKET',
	CREATETICKETSUPPORT: 'CREATE SUPPORT TICKET',
};
...
export const ICONS = {
	[TYPES.BILLING]: BILLING_OPTION,
	[TYPES.OUTAGE]: OUTAGE_OPTION,
	[TYPES.SUPPORT]: SUPPORT_OPTION,
